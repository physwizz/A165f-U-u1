...
cd kernel-5.10
python scripts/gen_build_config.py --kernel-defconfig a16_00_defconfig --kernel-defconfig-overlays entry_level.config -m user -o ../out/target/product/a16/obj/KERNEL_OBJ/build.config
